                            ...
                            @foreach ($categories as $category)
                                <div class="carousel-item rounded @if ($loop->first) active @endif">
                                    <img src="{{ asset('storage/' . $category->image) }}"
                                        class="img-fluid w-100 h-100 rounded" alt="{{ $category->name }}">
                            ...
                            <div class="col-lg-12">
                                <div class="row g-4">
                                    @foreach ($products as $product)
                                        <div class="col-md-6 col-lg-4 col-xl-3 h-">
                                            <div class="rounded position-relative fruite-item" style="height: 500px">
                                                ...
                                                <div class="p-4 border border-secondary border-top-0 rounded-bottom" style="height: 193px">
                                                    <h4>{{ $product->name }}</h4>
                    ...
                    <div class="border border-primary rounded position-relative vesitable-item"  style="height: 500px">
                        <div class="vesitable-img">
                            <img src="{{ asset('storage/' . $product->image) }}" class="img-fluid w-100 rounded-top"
                                alt="{{ $product->name }}" style="width: 306px; height: 306px; object-fit: cover;">
                        </div>
