...
<body>
              ...
              <ul class="sidebar-menu">
                ...
                <li class="dropdown">
                  <a href="#" class="menu-toggle nav-link has-dropdown"><i
                      data-feather="briefcase"></i><span>User page</span></a>
                  <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{route('user.home')}}">Homepage</a></li>
                    <li><a class="nav-link" href="{{route('user.cart')}}">Cart</a></li>
                  </ul>
                </li>
                <li class="dropdown">
    ...
    <!-- JS Libraies -->
    <script src="{{ asset('assets/auth/bundles/apexcharts/apexcharts.min.js') }}"></script>
    <!-- Page Specific JS File -->
    <script src="{{ asset('assets/auth/js/page/index.js') }}"></script>
    <!-- Template JS File -->
